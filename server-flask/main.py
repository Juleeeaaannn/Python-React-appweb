...
from flask_cors import CORS #biblioteca que sirve para hacer peticiones a la API desde el frontend
...
CORS(app) #Activamos CORS para la todas las rutas de flask 
...
if __name__ == '__main__':
    #db.create_all()
    app.run(debug=True) #debug activado para ver las correcciones en tiempo real